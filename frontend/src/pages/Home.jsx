...
const protectionPoints = [
  [
    "Fast prototype analysis",
    "A clear report in moments, designed for high-pressure calls.",
    Clock3,
  ],
  [
    "Signal-led assessment",
    "See the factors behind a result instead of a black-box verdict.",
    BarChart3,
  ],
  [
    "Private by design",
    "Audio is used for the current session and not retained by this demo.",
    LockKeyhole,
  ],
]
      ...
      <main className="min-h-screen overflow-hidden text-white">
        ...
        <section className="relative isolate border-b border-white/8 px-5 pb-20 pt-16 sm:px-8 sm:pt-24 lg:pb-28">
          <div className="relative mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[1fr_0.9fr]">
            ...
            <motion.div {...enter}>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                ...
                <motion.button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/4 px-5 py-3.5 text-sm font-semibold text-[#d8e2f5] transition hover:border-[#7eaaff]/60 hover:bg-[#13223e]"
                  whileHover={reduceMotion ? {} : { y: -2 }}
                  whileTap={reduceMotion ? {} : { scale: 0.98 }}
                >
            ...
            >
              <div className="signal-card rounded-4xl border border-white/10 bg-[#0c1322]/85 p-6 shadow-[0_30px_90px_rgba(1,5,17,0.65)] backdrop-blur sm:p-8">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2 text-center">
                  <div className="rounded-xl bg-white/4.5 px-2 py-3">
        ...
        <section className="relative border-y border-white/8 bg-[#070d18]/78 px-5 py-20 backdrop-blur-[2px] sm:px-8 lg:py-28">
          <div
            className="cyber-grid pointer-events-none absolute inset-0 opacity-70"
            aria-hidden="true"
          />
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            >
              <div className="max-w-2xl">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#7fa9f3]">
                  A calmer way to check a call
                </p>

                <h2 className="mt-4 font-display text-3xl font-semibold tracking-[-0.04em] text-[#edf3ff] sm:text-4xl">
                  From an unfamiliar voice to a clear next move.
                </h2>
              </div>
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-3">
              {processSteps.map(([number, title, copy, Icon], index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-xs text-[#78abf7]">
                      {number}
                    </span>

                    <span className="grid h-10 w-10 place-items-center rounded-xl border border-[#669bf2]/20 bg-[#1a345d]/45 text-[#9cc6ff]">
        ...
        <section className="bg-[#0a101d]/78 px-5 py-20 backdrop-blur-[2px] sm:px-8 lg:py-28">
          <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-[#6da3ff]/25 bg-[#132546] px-3 py-1.5 text-xs font-semibold tracking-[0.13em] text-[#a9c7ff]">
                <RadioTower className="h-3.5 w-3.5" />
                BUILT FOR THE MOMENT
              </div>

              <h2 className="mt-6 font-display text-3xl font-semibold tracking-[-0.04em] text-[#edf3ff] sm:text-4xl">
                Useful information, when hesitation matters.
              </h2>

              <p className="mt-5 max-w-md text-base leading-7 text-[#9ba9c0]">
                A convincing voice should not force an instant decision. Review
                the evidence, then verify through a contact channel you already
                trust.
              </p>
              ...
              <motion.button
                ...
                onClick={() =>
                  navigate("/analyzing", {
                    state: { source: "Quick prototype check" },
                  })
                }
                whileHover={reduceMotion ? {} : { y: -2 }}
                whileTap={reduceMotion ? {} : { scale: 0.98 }}
            ...
            <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
              {protectionPoints.map(([title, copy, Icon], index) => (
                ...
                >
                  <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[#18335d] text-[#9ac6ff]">
                    <Icon className="h-5 w-5" />
                  </span>

                  <div>
                    <h3 className="font-display text-base font-semibold text-[#e7efff]">
                      {title}
                    </h3>

                    <p className="mt-1.5 text-sm leading-6 text-[#96a4bc]">
                      {copy}
                    </p>
                  </div>
                </motion.article>
          ...
          >
            <div>
              ...
              <h2 className="mt-3 font-display text-2xl font-semibold tracking-[-0.04em] text-white sm:text-3xl">
                Start with the voice. Decide with confidence.
              </h2>
            </div>
            ...
            <motion.button
              ...
              whileHover={reduceMotion ? {} : { y: -2 }}
              whileTap={reduceMotion ? {} : { scale: 0.98 }}
              className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-white px-5 py-3.5 text-sm font-semibold text-[#12203b] transition hover:bg-[#e7efff]"
            >
              Upload a sample
              <Upload className="h-4 w-4" />
            </motion.button>
